...
# above recursive definition is same as this used in paper: Pn+1  (xi  )= 1  n+1  [(2n + 1) xiPn  (xi  ) − nPn−1  (xi  )] 
 ##with P0 (x) = 1 and P1 (x) = x, where x is the standardized GDD variable in the interval [−1, 1] and n is the order.
